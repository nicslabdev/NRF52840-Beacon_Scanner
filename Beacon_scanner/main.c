 ...
 * 
 *  This is a Bluetooth 5 scanner. This code reads every advertisement from beacons and
 *  send its data through serial port. By default, this reads PHY Coded advertisements.
 *
